...
public class PlayerAttackInfo
{
    ...
    [SerializeField]
    [Tooltip("THe button to press that will use this attack. This button must be put in input settings")]
    ...
    [SerializeField]
    [Tooltip("Where you spawn the ability game object with respect to the player")]
